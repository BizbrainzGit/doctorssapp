...
defined('EXIT__AUTO_MAX')      OR define('EXIT__AUTO_MAX', 125); // highest automatically-assigned error code
 ...
 define('ENCRYPT_KEY', 123456); // highest automatically-assigned error code

define('VALIDATION_MSG_REQUIRED_FIELD','field is required!!');
...
define('APPOINTMENTBOOKING_FAIL_MSG', 'Appointment Booking Are Completed This Doctor,Pls Try Again After Some Time...');
define('DWNLOAD_MSG', 'File Successfully Downloaded');
