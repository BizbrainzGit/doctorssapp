...
<div class="loader" style="display: none;"></div>
	<div class="container-scroller">
        ...
        <div class="text-left navbar-brand-wrapper d-flex align-items-center justify-content-between">
          <a class="navbar-brand brand-logo" href="/<?php echo base_url();?>Doctor-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" style="height: 60px" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/<?php echo base_url();?>Doctor-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG"  alt="logo"/></a> 
      ...
      <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
		...
		<a class="dropdown-item" href="/<?php echo base_url();?>Doctor-Profile">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="Doctor-Today-Appointments"> Today Appointments</a></li>
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Doctor-Manage-Appointments">Appointment List</a></li>
              </ul>
            </div>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Doctor-Manage-Prescription">
            <i class="mdi mdi-tooltip-edit menu-icon"></i>
            <span class="menu-title">Patients Prescription</span>
            </a>
          </li>
           ...
           <li class="nav-item">
            ...
            <i class="mdi mdi-account-multiple menu-icon"></i>
            <span class="menu-title">Doctor Reference</span>
            <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic1">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Doctor-Refer-By-A-Doctor">Refered By Me</a></li>
                 <li class="nav-item"><a class="nav-link" href="/<?php echo base_url();?>Doctor-Refer-A-Doctor">
                 <span class="menu-title">Refer A Doctor</span> </a> </li>
              </ul>
            </div>
          </li>
