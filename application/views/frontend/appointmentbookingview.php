				...
				<aside class="col-xl-4 col-lg-4" id="sidebar">
					<div class="box_general_3 booking">
						<form>
							...
							<div class="summary">
								<ul>
									<li>Date: <strong class="float-right"><span id="patient_booking_dateview"></span></strong></li>
									<li>Time: <strong class="float-right" id="patient_booking_timeview"></strong></li>
									<li>Doctor Name: <strong class="float-right" id="patient_booking_doctors_nameview">Dr. julia Jhones</strong></li>
								</ul>
							</div>
							<ul class="treatments checkout clearfix">
								<li>
									Fee <strong class="float-right" id="patient_booking_doctors_feeview">$55</strong>
								</li>
								
								<li class="total">
									Total <strong class="float-right" id="patient_booking_doctors_feeview">$110</strong>
								</li>
							</ul>
							<hr>
							<a href="/<?php echo base_url();?>Confirmview" class="btn_1 full-width">Confirm and pay</a>
						</form>
					</div>
					<!-- /box_general -->
				</aside>
