...
<script type="text/javascript">
  ...
  getSpecialization("#edit_appointmentbooking_department");
</script>
...
<script type="text/javascript">
 ...
 $( "#edit_appointmentbooking_date" ).datepicker({
      todayHighlight: true,
      autoclose  : true,
      startDate  : '0d',
       Format : 'dd-mm-yy'
