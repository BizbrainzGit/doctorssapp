...
<div class="loader" style="display: none"></div>
	...
	<div class="container-scroller">
        ...
        <div class="text-left navbar-brand-wrapper d-flex align-items-center justify-content-between">
          <a class="navbar-brand brand-logo" href="/<?php echo base_url();?>SuperAdmin-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" style="height:60px;" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/<?php echo base_url();?>SuperAdmin-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" height="60" alt="logo"/></a> 
	...
	<li class="nav-item  dropdown d-none align-items-center d-lg-flex d-none">	</li>
		...
		<!-- <a class="dropdown-item" href="/<?php echo base_url();?>Superadmin-Manage-Profile">
    ...
    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#changepswdModal"> <i class="mdi mdi-settings text-primary"></i> Change Password</a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-Packages">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-PaymentsMethodes">
            <i class="mdi mdi-package menu-icon"></i>
            <span class="menu-title">Manage Payments <br>Methodes</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-Accounts">
            <i class="mdi mdi-account-multiple-plus menu-icon"></i>
            <span class="menu-title">Manage Accounts</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-Subscriptions">
           ...
           <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-Healthdepartment">
            <i class="mdi mdi-account-card-details menu-icon"></i>
            <span class="menu-title">Manage Specialization</span>
            </a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-Promocode">
            <i class="mdi mdi-cash-100 menu-icon"></i>
            <span class="menu-title">Manage Promocode</span>
            </a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>SuperAdmin-Manage-Patient">
            <i class="mdi mdi-account-card-details menu-icon"></i>
            <span class="menu-title">Manage Patient View</span>
            </a>
          </li>
        </ul>
      </nav>
