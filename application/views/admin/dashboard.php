												...
												<div class="card">
													<div class="card-body">
														...
														<div id="sales" class="carousel slide dashboard-widget-carousel position-static pt-2" data-ride="carousel">
															<div class="carousel-inner">
																<div id="total_patientscount"></div>
															</div>
												...
												<div class="card">
													<div class="card-body">
														<div class="d-flex flex-wrap justify-content-between">
															...
															<div class="dropdown dropleft card-menu-dropdown">
																...
																<div class="dropdown-menu" aria-labelledby="cardMenuButtonpurchase" x-placement="left-start">
                                                                   <a class="dropdown-item" href="#" onClick="TotalAppointmentData(1);" ><?php echo date('M Y', strtotime('0 month')); ?></a>
																	<a class="dropdown-item" href="#" onClick="TotalAppointmentData(2);" ><?php echo date('M Y', strtotime('-1 month')); ?></a>
																  <a class="dropdown-item" onClick="TotalAppointmentData(3);" href="#"><?php echo date('M Y', strtotime('-2 month')); ?></a>
																  <a class="dropdown-item"  href="#" onClick="TotalAppointmentData(4);"><?php echo date('M Y', strtotime('-3 month')); ?></a>
														...
														<div id="purchases" class="carousel slide dashboard-widget-carousel position-static pt-2" data-ride="carousel">
															<div class="carousel-inner">
																<div id="totalapp_viewdashboard"></div>
															</div>
...
<script src="/<?php echo base_url();?>assets/js/admin/AdminDashboardController.js"></script>