...
defined('BASEPATH') OR exit('No direct script access allowed');
  include('Layouts/mdLayout_Header.php');
?>
...
<?php
include('Layouts/mdLayout_Footer.php');
?>

<script src="/<?php echo base_url();?>assets/js/Common/ProfileController.js" type="text/javascript"></script>
