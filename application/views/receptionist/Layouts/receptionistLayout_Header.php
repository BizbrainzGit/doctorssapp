...
<div class="loader" style="display: none"></div>
	<div class="container-scroller">
        ...
        <div class="text-left navbar-brand-wrapper d-flex align-items-center justify-content-between">
          <a class="navbar-brand brand-logo" href="/<?php echo base_url();?>Receptionist-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" style="height:60px;" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/<?php echo base_url();?>Receptionist-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" height="60" alt="logo"/></a> 
	    ...
	    <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
          		<a class="dropdown-item" href="/<?php echo base_url();?>Receptionist-Profile">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Receptionist-Dashboard">
            <i class="mdi mdi-view-dashboard menu-icon"></i>
            <span class="menu-title">Dashboard</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Receptionist-Manage-Patients">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Receptionist-New-AppointmentBooking">Appointment Booking</a></li>
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Receptionist-PendingForApproval-Appointments">Pending For Approval <br> Appointments</a></li>
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Receptionist-Manage-Appointments">Appointment List</a></li>
              </ul>
            </div>
          </li>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic1">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Receptionist-Add-Prescription">Add Prescription </a></li>
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Receptionist-Manage-Prescription">Prescription List</a></li>
              </ul>
            </div>
          </li>
        </ul>
