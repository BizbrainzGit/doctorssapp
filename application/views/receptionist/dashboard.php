													  ...
													  <div id="returns" class="carousel slide dashboard-widget-carousel position-static pt-2" data-ride="carousel">
															<div class="carousel-inner">
																<div class="carousel-item active">
																	...
																	<h2 class="mr-3"><span id="total_patients">120</span></h2>
																    </div>
																    <div class="mb-3 text-center">
																    	<h4 class="text-success">Total Patients </h4>
																    </div>
		                                                                <div class="mb-3 text-center">
		                                                                	 <a href="/<?php echo base_url();?>Receptionist-Manage-Patients">
															...
															<div class="carousel-inner">
																<div class="carousel-item active">
																    ...
																    <div class="mb-3 text-center">
		                                                                ...
		                                                                <div class="mb-3 text-center">
		                                                                	  <a  href="/<?php echo base_url();?>Receptionist-Manage-Appointments">
		                                                                	 <button class="btn btn-warning m-8 btn-outline-secondary btn-sm btn-icon-text"><span class="text-center">View</span> <i class="mdi mdi mdi-forward"></i> </button>
		                                                                	</a>
		                                                                </div>
															    </div>
															...
															<div class="carousel-inner">
																<div class="carousel-item active">
																    ...
																    <div class="mb-3 text-center">
		                                                                ...
		                                                                <div class="mb-3 text-center">
		                                                                	 <a  href="/<?php echo base_url();?>Receptionist-Manage-Prescription">
		                                                                	 <button class="btn btn-warning m-8 btn-outline-secondary btn-sm btn-icon-text"><span class="text-center">View</span> <i class="mdi mdi mdi-forward"></i></button>
		                                                                	</a>
		                                                                </div>
															    </div>
