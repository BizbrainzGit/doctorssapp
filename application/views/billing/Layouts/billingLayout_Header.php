...
<div class="loader" style="display: none"></div>
	<div class="container-scroller">
        ...
        <div class="text-left navbar-brand-wrapper d-flex align-items-center justify-content-between">
          <a class="navbar-brand brand-logo" href="/<?php echo base_url();?>Billing-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" style="height:60px;" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/<?php echo base_url();?>Billing-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.PNG" height="60" alt="logo"/></a> 
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Billing-Dashboard">
        ...
        <!--   <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Billing-MedicalTestsBilling">
            <i class="mdi mdi-clipboard-text menu-icon"></i>
            <span class="menu-title">Medical Tests Billing</span>
            </a>
          </li> -->
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Billing-AddMedicalTestsBilling">Add Medical Tests<br> Billing </a></li>
                <li class="nav-item"> <a class="nav-link" href="/<?php echo base_url();?>Billing-MedicalTestsBilling">Medical Test Bills List</a></li>
              </ul>
            </div>
          </li>
